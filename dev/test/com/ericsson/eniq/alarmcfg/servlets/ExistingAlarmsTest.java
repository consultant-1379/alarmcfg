 ...
 */
@RunWith(JMock.class)
public class ExistingAlarmsTest {
  ...
  public void testDoGet() {
    final WebRequest request = new GetMethodWebRequest("http://localhost/ExistingAlarms");
  ...
  /**
   * Test method for
   * {@link com.ericsson.eniq.alarmcfg.servlets.ExistingAlarms#doPost(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)}
   * .
   */
  @Ignore("Does not work")
  @Test
  public void testDoPostSuccess() {
    ...
    final WebRequest request = new PostMethodWebRequest("http://localhost/ExistingAlarms");
